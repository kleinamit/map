...
namespace musicTherapy1
{
	...
	public class InstrumentManager : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(InstrumentManager));
			...
			// buttonAddNew
			// 
			this.buttonAddNew.Location = new System.Drawing.Point(600, 16);
			...
			// buttonDelete
			// 
			this.buttonDelete.Location = new System.Drawing.Point(512, 16);
		...
		private void drawInstrument(string startCategoryName, string startCategoryParent, bool showAll)
		{
			...
			int upBorderHeight = 50;
			int heightOfPicture =100;
			int widthOfPicture = 100;
			int sidesBorderWidth = 200;
			int verticalIntervalBetweenPictures=50;
			int HorizontalIntervalBetweenPictures=10;
			int heighOfCategoryAndSubCategoryLable = 50;
			...
			topicLable.Size = new Size (1000,50);
			...
			for (int CategoryCount=0;CategoryCount<instCategList.Count;CategoryCount++)
			{
				...
				categoryLable.Size = new Size(5000,50);
				...
				{	
					...
					for (int imageCounter =0; imageCounter <imageList.Count;imageCounter++)
					{
						...
						instrumentName.Size = new Size(70,15);
						instrumentName.Location = new Point(/*x*/counterOfPicturesInLine*widthOfPicture+sidesBorderWidth+counterOfPicturesInLine*HorizontalIntervalBetweenPictures + 15,
							/*y*/105+upBorderHeight+counterOfPictureLines*heightOfPicture+counterOfPictureLines*verticalIntervalBetweenPictures+(globalCategoryAnsSubCategoryLineCounter+1)*heighOfCategoryAndSubCategoryLable);
				...
				else //has a sub catagory
				{
					...
					for (int subCategoryCounter =0 ;subCategoryCounter<subCategoryList.Count;subCategoryCounter++)
					{
						...
						subCategoryLable.Size = new Size(5000,50);
