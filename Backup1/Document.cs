...
namespace musicTherapy1
{
	...
	public class Document
	{
        ...
        public ArrayList SilencePanelList = new ArrayList();
        public ArrayList FramePanelList;// = new ArrayList();
        public ArrayList MusicNotesList = new ArrayList();
		...
		public int proportionOfPanelArearAndTextArea= 20;
		...
		public Color ColorForAbsentPatiant=Color.Gray;
		...
		public Document(int numOfPatiantsa, int sessionDurationa, int timeIntervalBetweenBarsa )
		{
          ...
          //  this.ColorForAbsentPatiant = 
            FramePanelList= new ArrayList();
		}
        public Document()
        {
            MessageBox.Show("fgfdgsfdgsd");
        }
	...
	public class TimeLine
	{
		...
		public string additionalInfoAboutPatiant="Add additional information about patient";
	...
	public class Minute
	{
       ...
       //public bool isSilencePanelStartHere = false;
    ...
    [Serializable]
    public class SilencePanel
    {
        public Color color;
        public string TimeOfSilence;
        public int opacity;
    ...
    public class MusicNotes
    {
        ...
        public int endPoint;
        public string tempo;
        public string NotesPictureFileName;
        public int Mafteach;
